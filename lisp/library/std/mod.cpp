...
//   The file lisp/library/std/mod.cpp
// 
...
DECLARE_CFUNCTION(LFunctionMod, 2, 2, "#<FUNCTION MOD>", "MOD")
...
DoApply(int paramsc, const SReference paramsv[], IntelibContinuation& lf) const
{
    ...
    if(op2<0) { op2 = -op2; op1 = -op1; }
    intelib_integer_t res = op1>0 ? op1 % op2 : op1 - (op1/op2)*op2 + op2;
